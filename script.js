// ============================================================
// HERO GROWER SLIDER LOGIC
// ============================================================
const sliderInner = document.getElementById('heroPhotoSlider');
if (sliderInner) {
  const photos = sliderInner.querySelectorAll('.slider-photo');
  let currentPhotoIndex = 0;
  const slideInterval = 4000; // ৪ সেকেন্ড পর পর ছবি পরিবর্তন হবে
  ...
  setInterval(cyclePhotos, slideInterval);
}

// ============================================================
// PORTFOLIO BOOK / WORKS DATA & LOGIC
// ============================================================
const bookPages = [
  {
...
// ============================================================
// ALL PROJECTS SHOWCASE GRID
// ============================================================
const allProjects = [
  { name: "Project Alpha", category: "Full Stack", year: "2024", desc: "Full-stack app with React + Node.js + MongoDB. User auth, dashboard, REST API.", icon: "💻", github: "https://github.com/YOUR_USERNAME/project-alpha", live: "https://your-live-site.com", video: "https://www.youtube.com/embed/YOUR_VIDEO_ID" },
  { name: "Project Beta", category: "E-Commerce", year: "2024", desc: "E-commerce platform with cart, Stripe payments, and admin panel.", icon: "🛒", github: "https://github.com/YOUR_USERNAME/project-beta", live: "https://your-live-site.com", video: "" },
  { name: "Project Gamma", category: "Mobile App", year: "2023", desc: "Social app with real-time chat, media uploads, and push notifications.", icon: "📱", github: "https://github.com/YOUR_USERNAME/project-gamma", live: "", video: "https://www.youtube.com/embed/YOUR_VIDEO_ID" },
  { name: "Project Delta", category: "Data Viz", year: "2023", desc: "Interactive analytics dashboard with D3.js and live data APIs.", icon: "📊", github: "https://github.com/YOUR_USERNAME/project-delta", live: "https://your-live-site.com", video: "" }
];
...
if (cvModal) {
  cvModal.addEventListener('click', function(e) { if (e.target === this) closeCvModal(); });
}
const vModal = document.getElementById('videoModal');
if (vModal) {
  vModal.addEventListener('click', function(e) { if (e.target === this) closeVideoModal(); });
}

function openCvModal(e) { if (e) e.preventDefault(); document.getElementById('cvModal').classList.add('active'); }
...
// ============================================================
// UTILITIES (SCROLL ANIMATIONS, NAV SCROLL, HAMBURGER)
// ============================================================
...
if (hamburger) {
  hamburger.addEventListener('click', () => { document.getElementById('mobileNav').classList.toggle('open'); });
}
...
const barObserver = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      entry.target.querySelectorAll('.skill-bar-fill').forEach(bar => { bar.style.transform = `scaleX(${parseInt(bar.dataset.w) / 100})`; });
    }
  });
}, { threshold: 0.3 });
